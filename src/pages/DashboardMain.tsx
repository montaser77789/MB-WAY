                ...
                <div className="flex items-center gap-2 p-2 text-blue_maincolor">
                  <div className="w-full">
                    <p className="font-bold text-[16px] text-nowrap break-words mb-3">
                      Deadline : <span className="font-medium break-words">18/12/2024</span>
                    </p>
                    <p className="font-bold text-[16px] text-nowrap break-words mb-3">
                      Section : <span className="font-medium break-words">commerce</span>
                    </p>
                    <p className="font-bold text-[16px] text-nowrap break-words mb-3">
                      Employee : <span className="font-medium break-words">Justin Carder</span>
                    </p>
                    <p className="font-bold text-[16px] text-nowrap break-words mb-3">
                      Manager : <span className="font-medium break-words">Justin Carder</span>
                    </p>
                  </div>
