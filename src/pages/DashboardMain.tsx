...
const DashboardMain = () => {
  return (
    <div className="overflow-x-hidden">
      ...
      <span className="w-2 h-2 bg-blue_maincolor rounded-full"></span>
      <p className="ml-1 text-[16px] font-bold leading-[16px] text-blue_maincolor ">Inbox message</p>
      </div>
      <div className="flex flex-row items-center justify-start mt-[26px]">
        <div className="box-border flex flex-col items-stretch justify-center w-[85px]">
          <p className="text-center text-[16px] font-bold leading-[16px] text-blue-700 cursor-pointer">Manager</p>
        ...
        <div className="box-border flex flex-col items-stretch justify-center w-[85px] ml-[13px]">
          <p className="text-center text-[16px] font-bold leading-[16px] text-gray-400 cursor-pointer">Employee</p>
    ...
    <div className="flex flex-row items-center mt-2">
      ...
      <div className="flex-1 pb-[3px] ml-[5px]">
        ...
        <div className="flex flex-row items-center mt-[-3px]">
          <p
            className="font-normal text-[12px] mt-1 leading-[12px] whitespace-pre-wrap"
